...
#define MAX MAX5
#define pii64 pair<int, i64>

class Compare {
public:
    int operator () (const pii64& p1, const pii64& p2) {
        return p1.second > p2.second;
    }
};

priority_queue <pii64, vector< pii64 >, Compare> Q;
vector < pii64 > adj[MAX + 1];
i64 dis[MAX + 1];
int n;
int par[MAX + 1];
...
void reset() {
    Q = priority_queue <pii64, vector< pii64 >, Compare> ();
    rep1(i, n) {
        dis[i] = INF64;
        adj[i].clear();
    }
